...
- CGS와 MGS는 정확한 산술에서 왜 같은 결과를 주는가?
- 부동소수점에서는 어느 갱신 순서가 직교성을 바꾸는가?

## 핵심 내용 체크리스트

- [ ] 두 알고리즘의 갱신식과 invariant
- [ ] 열의 선형종속, breakdown, 재직교화의 역할
...
**예정 대상:** `nla::classical_gram_schmidt` and `nla::modified_gram_schmidt`
...
**확인할 비교:** 거의 선형종속인 열에서 reconstruction과 orthogonality error를 비교한다.

### 지표

- A−QR의 상대 Frobenius norm
- 조건수별 Q*Q−I의 norm과 재직교화 전후 비교
...
**rank deficiency, 재직교화 누락, 0으로 나누기**
...
- 이전: [Lecture 07 — QR Factorization]({% link _posts/trefethen/2026-09-15-trefethen-07-qr-factorization.md %})
- 다음: [Lecture 09 — MATLAB]({% link _posts/trefethen/2026-09-15-trefethen-09-matlab.md %})
