---
layout: post
title: "Trefethen 08 — Gram-Schmidt Orthogonalization"
permalink: /study/trefethen/08-gram-schmidt-orthogonalization/
math: true
toc: true
status: outline
date: 2026-09-15 00:00:00 +0900
categories: [Numerical Methods]
tags: [numerical-linear-algebra, cpp, trefethen-bau, gram-schmidt-orthogonalization]
note_type: numerical-method
series: trefethen-nla
series_order: 8
---

- **Reference:** Trefethen and Bau, *Numerical Linear Algebra*, Lecture 8, “Gram-Schmidt Orthogonalization”
...
Implement the different computation orders of CGS and MGS.
...
- Background: Orthogonal projection and normalization

## Guiding questions

- Why are CGS and MGS equivalent in exact arithmetic?
- Which change in update order affects orthogonality in floating-point arithmetic?

## Coverage checklist

- [ ] Update formulas and invariants of both algorithms
- [ ] Linear dependence, breakdown, and the role of reorthogonalization
...
**Planned target:** `nla::classical_gram_schmidt` and `nla::modified_gram_schmidt`
...
**Planned comparison:** Compare reconstruction and orthogonality errors for nearly linearly dependent columns.

### Metrics

- Relative Frobenius norm of A−QR
- Norm of $Q^{\ast}Q-I$ versus condition number, before and after reorthogonalization
...
**Rank deficiency, missing reorthogonalization, and division by zero**
...
- Previous: [Lecture 07 — QR Factorization]({% link _posts/trefethen/2026-09-15-trefethen-07-qr-factorization.md %})
- Next: [Lecture 09 — MATLAB]({% link _posts/trefethen/2026-09-15-trefethen-09-matlab.md %})
