...
Arnoldi iteration으로 Krylov orthonormal basis와 Hessenberg projection을 만든다.
...
- 배경: Krylov subspace와 직교화

## 먼저 답할 질문

- Arnoldi relation의 마지막 벡터 항은 왜 필요한가?
- happy breakdown과 수치적 직교성 손실은 어떻게 구분하는가?

## 핵심 내용 체크리스트

- [ ] Krylov basis 구성과 Hessenberg recurrence
- [ ] 재직교화와 작은 subdiagonal 처리
...
**예정 대상:** `nla::arnoldi` in `iterative.*`
...
**확인할 비교:** Arnoldi relation, orthogonality, happy breakdown을 검사한다.

### 지표

- Arnoldi relation의 정규화 잔차
- Q*Q−I의 norm과 basis 크기별 matvec·직교화 비용
...
- 이전: [Lecture 32 — Overview of Iterative Methods]({% link _posts/trefethen/2026-09-15-trefethen-32-overview-of-iterative-methods.md %})
- 다음: [Lecture 34 — How Arnoldi Locates Eigenvalues]({% link _posts/trefethen/2026-09-15-trefethen-34-how-arnoldi-locates-eigenvalues.md %})
