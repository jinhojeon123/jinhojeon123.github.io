...
Lanczos projection과 Gauss quadrature의 연결을 수치적으로 재구성한다.
...
- 배경: Hermitian spectral decomposition과 다항식 적분

## 먼저 답할 질문

- Lanczos의 작은 tridiagonal 행렬은 어떻게 quadrature node·weight를 주는가?
- polynomial exactness와 일반 함수의 근사 오차는 어떻게 구분하는가?

## 핵심 내용 체크리스트

- [ ] spectral measure와 bilinear form의 연결
- [ ] Gauss quadrature의 가정과 exactness 범위 유도
...
**예정 대상:** `experiments/l37_gauss_quadrature.cpp`
...
**확인할 비교:** iteration별 bilinear-form 또는 integral estimate 오차를 기록한다.

### 지표

- 작은 Hermitian 문제의 정확한 spectral sum과 비교
- 다항식 차수·Lanczos 단계별 quadrature 오차
...
**함수의 smoothness와 spectrum 범위를 확인하지 않음**
...
- 이전: [Lecture 36 — The Lanczos Iteration]({% link _posts/trefethen/2026-09-15-trefethen-36-the-lanczos-iteration.md %})
- 다음: [Lecture 38 — Conjugate Gradients]({% link _posts/trefethen/2026-09-15-trefethen-38-conjugate-gradients.md %})
