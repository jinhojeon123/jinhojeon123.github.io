...
고유값 알고리즘의 reduction·iteration 구조와 적용 범위를 정리한다.
개인 C++ 확장으로 power iteration을 사용해 수렴 조건을 관찰한다.
...
- 고유값 계산은 왜 reduction과 iteration을 나누어 설명하는가?
- 전체 spectrum과 일부 고유쌍을 구하는 방법은 어떻게 다른가?

## 핵심 내용 체크리스트

- [ ] 직접법·반복법, similarity reduction의 역할
- [ ] 개인 확장: power iteration의 초기벡터·spectral gap 조건
...
**예정 대상:** 개인 확장: `nla::power_iteration` in `eigenvalues.*`
...
**확인할 비교:** dominant eigenvalue 비율과 residual history의 기울기를 비교한다.

### 지표

- power iteration의 eigenpair 잔차 이력
- dominant eigenvalue 비율과 초기벡터별 반복 횟수
...
**eigenvalue estimate 변화만으로 수렴 판정**
...
- 이전: [Lecture 24 — Eigenvalue Problems]({% link _posts/trefethen/2026-09-15-trefethen-24-eigenvalue-problems.md %})
- 다음: [Lecture 26 — Reduction to Hessenberg or Tridiagonal Form]({% link _posts/trefethen/2026-09-15-trefethen-26-reduction-to-hessenberg-or-tridiagonal-form.md %})
