---
layout: post
title: "Trefethen 25 — Overview of Eigenvalue Algorithms"
permalink: /study/trefethen/25-overview-of-eigenvalue-algorithms/
math: true
toc: true
status: outline
date: 2026-09-15 00:00:00 +0900
categories: [Numerical Methods]
tags: [numerical-linear-algebra, cpp, trefethen-bau, overview-of-eigenvalue]
note_type: numerical-method
series: trefethen-nla
series_order: 25
---

- **Reference:** Trefethen and Bau, *Numerical Linear Algebra*, Lecture 25, “Overview of Eigenvalue Algorithms”
- **Part:** **V — Eigenvalues**
...
Explain the reduction/iteration structure and scope of eigenvalue algorithms. As a personal C++ extension, use power iteration to observe its convergence conditions.
...
- Background: Polynomial roots and iterative convergence

## Guiding questions

- Why are eigenvalue algorithms described in terms of reduction and iteration?
- How do methods for the full spectrum differ from methods for selected eigenpairs?

## Coverage checklist

- [ ] Direct and iterative approaches and the role of similarity reduction
- [ ] Personal extension: initial-vector and spectral-gap conditions for power iteration
...
**Planned target:** Personal extension: `nla::power_iteration` in `eigenvalues.*`
...
**Planned comparison:** Compare the dominant-eigenvalue ratio with the slope of the residual history.

### Metrics

- History of eigenpair residuals in power iteration
- Iteration counts versus dominant-eigenvalue ratio and initial vector
...
**Declaring convergence from changes in the eigenvalue estimate alone**
...
- Previous: [Lecture 24 — Eigenvalue Problems]({% link _posts/trefethen/2026-09-15-trefethen-24-eigenvalue-problems.md %})
- Next: [Lecture 26 — Reduction to Hessenberg or Tridiagonal Form]({% link _posts/trefethen/2026-09-15-trefethen-26-reduction-to-hessenberg-or-tridiagonal-form.md %})
