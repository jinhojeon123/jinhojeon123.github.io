---
layout: post
title: "Trefethen 29 — QR Algorithm with Shifts"
permalink: /study/trefethen/29-qr-algorithm-with-shifts/
math: true
toc: true
status: outline
date: 2026-09-15 00:00:00 +0900
categories: [Numerical Methods]
tags: [numerical-linear-algebra, cpp, trefethen-bau, qr-algorithm-with]
note_type: numerical-method
series: trefethen-nla
series_order: 29
---

- **Reference:** Trefethen and Bau, *Numerical Linear Algebra*, Lecture 29, “QR Algorithm with Shifts”
- **Part:** **V — Eigenvalues**
...
Accelerate QR convergence with shift selection and deflation.
...
- [Lecture 27 — Rayleigh Quotient, Inverse Iteration]({% link _posts/trefethen/2026-09-15-trefethen-27-rayleigh-quotient-inverse-iteration.md %})
- [Lecture 28 — QR Algorithm without Shifts]({% link _posts/trefethen/2026-09-15-trefethen-28-qr-algorithm-without-shifts.md %})
- Background: Shifts and deflation

## Guiding questions

- Does adding and subtracting a shift preserve the similarity relation?
- Why should a deflation test account for the scale of adjacent diagonal entries?

## Coverage checklist

- [ ] Shift selection and deflation criteria
- [ ] Start with Hermitian tridiagonal experiments and distinguish extensions to general matrices
...
**Planned target:** `nla::qr_algorithm(..., true)` with shift and deflation
...
**Planned comparison:** Compare shifted and unshifted iteration counts and deflation timing.

### Metrics

- Iteration counts and deflation locations with and without shifts
- Final residuals, orthogonality, and stopping decisions under rescaling
...
**Ignoring the scale dependence of deflation tolerances**
...
- Previous: [Lecture 28 — QR Algorithm without Shifts]({% link _posts/trefethen/2026-09-15-trefethen-28-qr-algorithm-without-shifts.md %})
- Next: [Lecture 30 — Other Eigenvalue Algorithms]({% link _posts/trefethen/2026-09-15-trefethen-30-other-eigenvalue-algorithms.md %})
