...
shift 선택과 deflation을 추가해 QR 수렴을 가속한다.
...
- shift를 더하고 빼도 similarity 관계가 유지되는가?
- deflation 판단은 왜 인접 대각 성분의 scale을 고려해야 하는가?

## 핵심 내용 체크리스트

- [ ] shift 선택과 deflation criterion
- [ ] Hermitian tridiagonal 실험을 먼저 고정하고 일반 행렬 확장 구분
...
**예정 대상:** `nla::qr_algorithm(..., true)` with shift and deflation
...
**확인할 비교:** shifted/unshifted iteration count와 deflation 시점을 비교한다.

### 지표

- shift 유무별 반복 횟수와 deflation 위치
- 최종 잔차·직교성 및 크기 재조정에 대한 종료 판단
...
**deflation tolerance가 scale에 의존함을 무시**
...
- 이전: [Lecture 28 — QR Algorithm without Shifts]({% link _posts/trefethen/2026-09-15-trefethen-28-qr-algorithm-without-shifts.md %})
- 다음: [Lecture 30 — Other Eigenvalue Algorithms]({% link _posts/trefethen/2026-09-15-trefethen-30-other-eigenvalue-algorithms.md %})
