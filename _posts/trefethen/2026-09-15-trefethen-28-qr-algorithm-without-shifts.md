...
unshifted QR iteration과 simultaneous iteration의 연결을 구현한다.
...
- 배경: similarity, orthogonal iteration

## 먼저 답할 질문

- QR step이 similarity transform이라는 것을 어떻게 보이는가?
- shift 없는 QR은 어느 경우에 느리거나 멈추는가?

## 핵심 내용 체크리스트

- [ ] QR iteration과 simultaneous iteration의 연결
- [ ] Hermitian·일반 입력의 목표 form과 수렴 가정
...
**예정 대상:** `nla::qr_algorithm(..., false)` in `eigenvalues.*`
...
**확인할 비교:** 대칭 및 일반 행렬에서 subdiagonal norm과 eigenvalue residual을 추적한다.

### 지표

- subdiagonal 크기의 변화
- 누적 Q의 직교성과 Schur·eigenpair 잔차
...
**Hessenberg reduction 없이 매 step dense QR을 사용한 비용 해석**
...
- 이전: [Lecture 27 — Rayleigh Quotient, Inverse Iteration]({% link _posts/trefethen/2026-09-15-trefethen-27-rayleigh-quotient-inverse-iteration.md %})
- 다음: [Lecture 29 — QR Algorithm with Shifts]({% link _posts/trefethen/2026-09-15-trefethen-29-qr-algorithm-with-shifts.md %})
