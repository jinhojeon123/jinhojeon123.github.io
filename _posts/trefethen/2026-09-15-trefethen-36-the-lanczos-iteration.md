...
Hermitian 행렬에서 3-term Lanczos recurrence를 구현한다.
...
- 배경: Hermitian 행렬과 Arnoldi relation

## 먼저 답할 질문

- Hermitian 가정이 Arnoldi를 왜 three-term recurrence로 줄이는가?
- 짧은 recurrence가 부동소수점에서도 전체 직교성을 보장하는가?

## 핵심 내용 체크리스트

- [ ] Lanczos tridiagonal relation 유도
- [ ] 정확한 산술과 직교성 손실·ghost Ritz value 구분
...
**예정 대상:** `nla::lanczos` in `iterative.*`
...
**확인할 비교:** tridiagonal projection, recurrence residual, finite-precision orthogonality loss를 측정한다.

### 지표

- Lanczos relation 잔차와 Q의 직교성
- tridiagonal 구조 및 재직교화 전후 Ritz value 비교
...
**대칭성 전제를 검사하지 않거나 ghost Ritz value를 무시**
...
- 이전: [Lecture 35 — GMRES]({% link _posts/trefethen/2026-09-15-trefethen-35-gmres.md %})
- 다음: [Lecture 37 — From Lanczos to Gauss Quadrature]({% link _posts/trefethen/2026-09-15-trefethen-37-from-lanczos-to-gauss-quadrature.md %})
