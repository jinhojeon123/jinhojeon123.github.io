---
layout: post
title: "Trefethen 14 — Stability"
permalink: /study/trefethen/14-stability/
math: true
toc: true
status: outline
date: 2026-09-15 00:00:00 +0900
categories: [Numerical Methods]
tags: [numerical-linear-algebra, cpp, trefethen-bau, stability]
note_type: numerical-method
series: trefethen-nla
series_order: 14
---

- **Reference:** Trefethen and Bau, *Numerical Linear Algebra*, Lecture 14, “Stability”
...
Measure forward and backward error separately.
...
- Background: The mathematical problem and its computed result

## Guiding questions

- Which input is perturbed when defining backward error?
- Can a small backward error coexist with a large forward error?

## Coverage checklist

- [ ] Definitions of forward error, backward error, and stability
- [ ] The reasoning that connects conditioning and stability
...
**Planned target:** `nla::linear_system_backward_error` in `stability.*`
...
**Planned comparison:** Apply both error metrics to the same approximate solution and interpret them together with conditioning.

### Metrics

- Normwise backward error for a linear system
- Forward error and condition number recorded for the same experiment
...
**Inferring small forward error from a small residual alone**
...
- Previous: [Lecture 13 — Floating Point Arithmetic]({% link _posts/trefethen/2026-09-15-trefethen-13-floating-point-arithmetic.md %})
- Next: [Lecture 15 — More on Stability]({% link _posts/trefethen/2026-09-15-trefethen-15-more-on-stability.md %})
