...
→ [Numerical Linear Algebra]({% link _posts/saad/2026-09-11-saad-01-sparse-linear-systems.md %})
→ [Krylov Methods]({% link _posts/saad/2026-09-11-saad-04-krylov-subspaces.md %})
→ [Preconditioning]({% link _posts/saad/2026-09-11-saad-09-preconditioning.md %})
→ [Domain Decomposition]({% link _posts/saad/2026-09-11-saad-14-domain-decomposition-bridge.md %})

[Measure Theory / Functional Analysis]({% link measure-theory/index.md %})
→ [Lp spaces]({% link _posts/seminar/2026-08-14-Lp-space-and-inequalities-04.md %})
→ [Duality]({% link _posts/folland-seminar/2026-09-11-folland-week-05-duality-of-lp.md %})
→ [PDE functional framework]({% link _projects/numerical-pde-fem.md %})

[Linear Algebra → PDE]({% link _posts/linear-algebra-review/2026-09-11-linear-algebra-19-bridge-to-numerical-pde.md %})
